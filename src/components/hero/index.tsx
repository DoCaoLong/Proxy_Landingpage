...
const HeroSection: React.FC = () => (
    <section className="text-center px-4 custom-padding">
        ...
        <p className="mt-5 max-w-2xl mx-auto text-white font-light text-size-normal">
            We offer the world's leading proxy exchange platform with support
            for P2P connections. Share Your Internet and Make Money Online
            Easily.
        </p>
